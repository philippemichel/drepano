...
tabcph(tt[,c(2, 3, 4, 7:12)], groupe,tit = "Description démographique",export = expt)
```
...
tabcph(tt[,c(2,29:34,36:45)], groupe,tit = "Antécédents", lt = TRUE,export = expt)
```
...
tabl |> 
kbl(caption = "VEMS corrigé et Anomalies radiologiques",
                row.names = FALSE,booktabs = TRUE,
             longtable = FALSE) |> 
